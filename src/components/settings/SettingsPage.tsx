            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'تفعيل المصادقة الثنائية للمستخدمين' : 'Enable 2FA for users'}</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'طلب تأكيد البريد عند التسجيل' : 'Require email confirmation on signup'}</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'السماح بإعادة تعيين كلمة المرور' : 'Allow password reset functionality'}</p>
                </div>
                <Switch
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'إصدار النظام' : 'System Version'}</p>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'حالة قاعدة البيانات' : 'Database Status'}</p>
              <p className="font-semibold text-green-600">{dir === 'rtl' ? 'متصلة' : 'Connected'}</p>
            </div>
            
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'وقت التشغيل' : 'Uptime'}</p>
