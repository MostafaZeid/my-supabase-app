  ...
  return (
    <TooltipProvider>
      <div className="space-y-6 p-6" dir={dir}>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">{t('deliverables.title')}</h1>
            <p className="text-muted-foreground mt-1">{t('deliverables.description')}</p>
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'إجمالي المخرجات' : 'Total Deliverables'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'قيد المراجعة' : 'Under Review'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'معتمد' : 'Approved'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{dir === 'rtl' ? 'مسودة' : 'Draft'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
