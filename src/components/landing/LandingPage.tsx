        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <button onClick={() => scrollToSection('features')} className="text-foreground hover:text-[#1B4FFF] transition-colors">
                {t.features}
              </button>
              <button onClick={() => scrollToSection('preview')} className="text-foreground hover:text-[#1B4FFF] transition-colors">
                {t.preview}
              </button>
              <button onClick={() => scrollToSection('workflow')} className="text-foreground hover:text-[#1B4FFF] transition-colors">
                {t.workflow}
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-foreground hover:text-[#1B4FFF] transition-colors">
                {t.pricing}
              </button>
              <button onClick={() => scrollToSection('contact')} className="text-foreground hover:text-[#1B4FFF] transition-colors">
                {t.contact}
              </button>
            </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  onClick={onEnterPlatform}
                  className="bg-white text-primary hover:bg-gray-50 px-8 py-4 text-lg font-semibold shadow-modern-xl rounded-xl transition-all duration-300 hover:scale-105"
                >
                  {t.startExploring}
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full btn-modern-warning">
