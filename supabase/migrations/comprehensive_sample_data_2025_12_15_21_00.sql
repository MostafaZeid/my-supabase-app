-- إضافة بيانات تجريبية شاملة للنظام المتقدم

-- إدراج مشاريع تجريبية متقدمة
...
('PROJ_ADV_001', 
 ...
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), '2024-01-10 09:00:00+03'),
...
('PROJ_ADV_002',
 ...
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), '2024-01-25 10:30:00+03'),
...
('PROJ_ADV_003',
 ...
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), '2024-02-20 14:15:00+03'),

-- مشروع 4: تطوير الاستراتيجية (مكتمل)
('PROJ_ADV_004',
 'مشروع تطوير الاستراتيجية المؤسسية',
 'Institutional Strategy Development Project',
 'وضع استراتيجية شاملة للنمو والتوسع مع خطط تنفيذية مفصلة لمدة 5 سنوات',
 'Developing comprehensive growth and expansion strategy with detailed 5-year implementation plans',
 'client3@albayan.com', 'شركة الدمام للصناعات المتطورة', 'Dammam Advanced Industries Company', 'main_client',
 'lead@consultant.com', 'سارة خالد الاستراتيجية',
 '2023-10-01', '2024-03-01', '2023-10-01', '2024-03-01',
 'completed', 'high', 100.00, 100.00,
 600000.00, 600000.00,
 true, true, true, true,
 'DAI-STR-2023-004', 'التخطيط الاستراتيجي', 'Strategic Planning',
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), '2023-09-15 11:00:00+03');
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_001' AND phase_order = 1),
 'PROJ_ADV_001', 'تقرير تحليل الفجوة الشامل', 'Comprehensive Gap Analysis Report',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_001' AND phase_order = 1),
 'PROJ_ADV_001', 'دراسة التحليل التشغيلي', 'Operational Analysis Study',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_001' AND phase_order = 2),
 'PROJ_ADV_001', 'تصميم قاعدة البيانات', 'Database Design',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_001' AND phase_order = 2),
 'PROJ_ADV_001', 'واجهات المستخدم', 'User Interfaces',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_002' AND phase_order = 1),
 'PROJ_ADV_002', 'تقرير تحليل الموارد البشرية', 'HR Analysis Report',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_002' AND phase_order = 2),
 'PROJ_ADV_002', 'الهيكل التنظيمي الجديد', 'New Organizational Structure',
...
((SELECT id FROM project_phases_2025_12_15_21_00 WHERE project_id = 'PROJ_ADV_002' AND phase_order = 2),
 'PROJ_ADV_002', 'دليل السياسات والإجراءات', 'Policies and Procedures Manual',
...
INSERT INTO meetings_2025_12_15_21_00 (
  ...
  organizer_id, organizer_name, status, meeting_type, priority,
...
('اجتماع مراجعة تقدم المشروع الأول', 'Project Progress Review Meeting #1',
 ...
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), 'أحمد محمد الخبير',
 'scheduled', 'project_review', 'high',
 true, 'يرجى مراجعة تقارير التقدم المرسلة مسبقاً', 'Please review the progress reports sent earlier',
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1)),
...
('اجتماع مراجعة المخرجات', 'Deliverables Review Meeting',
 ...
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), 'فاطمة أحمد المستشارة',
 'scheduled', 'deliverable_review', 'medium',
 false, null, null,
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1));

-- إدراج أجندة الاجتماعات
INSERT INTO meeting_agenda_2025_12_15_21_00 (
  meeting_id, agenda_item_order, agenda_title, agenda_title_en,
  description, description_en, estimated_duration_minutes,
  presenter_id, presenter_name, item_type, status
) VALUES
-- أجندة الاجتماع الأول
((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 1, 'افتتاح الاجتماع والترحيب', 'Meeting Opening and Welcome',
 'ترحيب بالحضور ومراجعة أجندة الاجتماع', 'Welcome attendees and review meeting agenda',
 5, (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), 'أحمد محمد الخبير',
 'presentation', 'pending'),

((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 2, 'مراجعة تقدم المرحلة الثانية', 'Phase 2 Progress Review',
 'عرض مفصل لتقدم مرحلة رسم الاحتياجات', 'Detailed presentation of Requirements Design Phase progress',
 30, (SELECT id FROM auth.users WHERE email = 'sub@consultant.com' LIMIT 1), 'علي أحمد المحلل',
 'presentation', 'pending'),

((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 3, 'مناقشة التحديات والحلول', 'Challenges and Solutions Discussion',
 'مناقشة التحديات الحالية واقتراح الحلول', 'Discuss current challenges and propose solutions',
 40, (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1), 'أحمد محمد الخبير',
 'discussion', 'pending'),

((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 4, 'اعتماد الخطوات التالية', 'Approve Next Steps',
 'اعتماد خطة العمل للفترة القادمة', 'Approve work plan for the upcoming period',
 15, (SELECT id FROM auth.users WHERE email = 'main@client.com' LIMIT 1), 'مدير المشروع من العميل',
 'decision', 'pending');

-- إدراج حضور الاجتماعات
INSERT INTO meeting_attendees_2025_12_15_21_00 (
  meeting_id, attendee_id, attendee_name, attendee_role, attendee_email,
  invitation_status, attendance_status, is_required
) VALUES
-- حضور الاجتماع الأول
((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1),
 'أحمد محمد الخبير', 'مدير المشروع', 'lead@consultant.com',
 'accepted', 'pending', true),

((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 (SELECT id FROM auth.users WHERE email = 'main@client.com' LIMIT 1),
 'مدير المشروع من العميل', 'عميل رئيسي', 'main@client.com',
 'accepted', 'pending', true),

((SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'),
 (SELECT id FROM auth.users WHERE email = 'sub@consultant.com' LIMIT 1),
 'علي أحمد المحلل', 'مستشار فرعي', 'sub@consultant.com',
 'accepted', 'pending', true);

-- إدراج رسائل تجريبية
INSERT INTO internal_messages_2025_12_15_21_00 (
  project_id, sender_id, sender_name, sender_role,
  recipient_id, recipient_name, recipient_role,
  subject, subject_en, message_content, message_content_en,
  message_type, status, priority, requires_response
) VALUES
('PROJ_ADV_001',
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1),
 ...
 'تحديث حول تقدم المشروع', 'Project Progress Update',
 'نود إعلامكم بأن المرحلة الثانية من المشروع تسير وفق الخطة المحددة مع تحقيق 75% من الأهداف المطلوبة.',
 'We would like to inform you that Phase 2 of the project is proceeding according to plan with 75% of required objectives achieved.',
 'general', 'sent', 'normal', false),
...
('PROJ_ADV_002',
 ...
 'ملاحظات على الهيكل التنظيمي', 'Comments on Organizational Structure',
 'لدينا بعض الملاحظات على الهيكل التنظيمي المقترح ونود مناقشتها في أقرب وقت ممكن.',
 'We have some comments on the proposed organizational structure and would like to discuss them as soon as possible.',
 'deliverable_review', 'sent', 'high', true);
...
('deliverable', (SELECT id FROM deliverables_advanced_2025_12_15_21_00 WHERE deliverable_code = 'PROJ_ADV_001_DEL_001'), 'approve',
...
('meeting', (SELECT id FROM meetings_2025_12_15_21_00 WHERE meeting_title = 'اجتماع مراجعة تقدم المشروع الأول'), 'create',
 'تم إنشاء اجتماع مراجعة تقدم المشروع الأول',
 'Created Project Progress Review Meeting #1',
 (SELECT id FROM auth.users WHERE email = 'lead@consultant.com' LIMIT 1),
 'أحمد محمد الخبير', 'مدير المشروع',
 'PROJ_ADV_001', 'اجتماع مراجعة مشروع');