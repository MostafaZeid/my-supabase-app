-- ==========================================
-- Deliverables Tree System with Weights
-- ==========================================
...
CREATE INDEX idx_deliverables_project_id ON deliverables_tree_2025_12_16_22_00(project_id);
CREATE INDEX idx_deliverables_status ON deliverables_tree_2025_12_16_22_00(status);
CREATE INDEX idx_deliverables_weight ON deliverables_tree_2025_12_16_22_00(weight);
CREATE INDEX idx_deliverables_display_order ON deliverables_tree_2025_12_16_22_00(display_order);

CREATE INDEX idx_parts_deliverable_id ON deliverable_parts_2025_12_16_22_00(deliverable_id);
CREATE INDEX idx_parts_assigned_user ON deliverable_parts_2025_12_16_22_00(assigned_user_id);
CREATE INDEX idx_parts_status ON deliverable_parts_2025_12_16_22_00(status);
CREATE INDEX idx_parts_display_order ON deliverable_parts_2025_12_16_22_00(display_order);

CREATE INDEX idx_final_files_deliverable ON deliverable_final_files_2025_12_16_22_00(deliverable_id);
CREATE INDEX idx_part_versions_part_id ON deliverable_part_versions_2025_12_16_22_00(part_id);
CREATE INDEX idx_part_versions_version ON deliverable_part_versions_2025_12_16_22_00(part_id, version_number);
...
CREATE POLICY "system_admin_deliverables_all" ON deliverables_tree_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
...
CREATE POLICY "project_manager_deliverables_all" ON deliverables_tree_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "project_consultant_deliverables_read" ON deliverables_tree_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "main_client_deliverables_read" ON deliverables_tree_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "sub_client_deliverables_read" ON deliverables_tree_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
-- System Admin: Full access
CREATE POLICY "system_admin_parts_all" ON deliverable_parts_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'system_admin'
...
-- Project Manager: Full access
CREATE POLICY "project_manager_parts_all" ON deliverable_parts_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'project_manager'
...
CREATE POLICY "project_consultant_parts_read" ON deliverable_parts_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'project_consultant'
...
CREATE POLICY "project_consultant_parts_update_assigned" ON deliverable_parts_2025_12_16_22_00
  FOR UPDATE USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "clients_parts_read" ON deliverable_parts_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "system_admin_final_files_all" ON deliverable_final_files_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'system_admin'
...
CREATE POLICY "project_manager_final_files_all" ON deliverable_final_files_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'project_manager'
...
CREATE POLICY "others_final_files_read" ON deliverable_final_files_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "system_admin_part_versions_all" ON deliverable_part_versions_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'system_admin'
...
CREATE POLICY "project_manager_part_versions_all" ON deliverable_part_versions_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role = 'project_manager'
...
CREATE POLICY "consultant_part_versions_assigned" ON deliverable_part_versions_2025_12_16_22_00
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
...
CREATE POLICY "clients_part_versions_read" ON deliverable_part_versions_2025_12_16_22_00
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM user_profiles_extended_2025_12_16_14_00 up
      WHERE up.user_id = auth.uid() AND up.role IN ('main_client', 'sub_client')
