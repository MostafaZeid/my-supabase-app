-- إضافة بيانات تجريبية للمشروع (مصححة)

-- إضافة مراحل المشروع
INSERT INTO project_phases_tree_2025_12_16_22_00 (id, project_id, title, description, planned_start_date, planned_end_date, status) VALUES
('phase-1', '1', 'مرحلة التخطيط والتحليل', 'تحليل المتطلبات وإعداد الخطة التفصيلية للمشروع', '2024-01-01', '2024-01-31', 'COMPLETED'),
...
-- إضافة أنشطة للمراحل
INSERT INTO project_activities_2025_12_16_22_00 (id, phase_id, title, description, status, progress_percent, planned_start_date, planned_end_date, actual_start_date, actual_end_date) VALUES
-- أنشطة مرحلة التخطيط
('activity-1-1', 'phase-1', 'تحليل المتطلبات الوظيفية', 'جمع وتحليل جميع المتطلبات الوظيفية للنظام', 'COMPLETED', 100, '2024-01-01', '2024-01-15', '2024-01-01', '2024-01-14'),
('activity-1-2', 'phase-1', 'إعداد الخطة التفصيلية', 'وضع الخطة الزمنية التفصيلية للمشروع', 'COMPLETED', 100, '2024-01-16', '2024-01-31', '2024-01-16', '2024-01-30'),

-- أنشطة مرحلة التصميم والتطوير
('activity-2-1', 'phase-2', 'تصميم قاعدة البيانات', 'تصميم هيكل قاعدة البيانات والجداول', 'COMPLETED', 100, '2024-02-01', '2024-02-15', '2024-02-01', '2024-02-14'),
('activity-2-2', 'phase-2', 'تطوير واجهة المستخدم', 'تطوير واجهات المستخدم الرئيسية', 'IN_PROGRESS', 75, '2024-02-16', '2024-03-31', '2024-02-16', null),
('activity-2-3', 'phase-2', 'تطوير APIs الخلفية', 'تطوير خدمات الويب والـ APIs', 'IN_PROGRESS', 60, '2024-03-01', '2024-04-15', '2024-03-01', null),
('activity-2-4', 'phase-2', 'التكامل والاختبار الأولي', 'ربط المكونات واختبارها', 'NOT_STARTED', 0, '2024-04-16', '2024-04-30', null, null),

-- أنشطة مرحلة الاختبار والتسليم
('activity-3-1', 'phase-3', 'اختبار النظام الشامل', 'إجراء اختبارات شاملة للنظام', 'NOT_STARTED', 0, '2024-05-01', '2024-05-31', null, null),
('activity-3-2', 'phase-3', 'إعداد التوثيق النهائي', 'كتابة دليل المستخدم والتوثيق التقني', 'NOT_STARTED', 0, '2024-06-01', '2024-06-15', null, null),
('activity-3-3', 'phase-3', 'التسليم والنشر', 'نشر النظام وتسليمه للعميل', 'NOT_STARTED', 0, '2024-06-16', '2024-06-30', null, null);

-- إضافة مخرجات المشروع
INSERT INTO deliverables_tree_2025_12_16_22_00 (id, project_id, title, description, weight, weight_unit, status) VALUES
...
INSERT INTO deliverable_parts_2025_12_16_22_00 (id, deliverable_id, title, description, weight, weight_unit, status) VALUES
-- أجزاء دليل المستخدم
