-- إضافة نظام المراجعة والاعتماد للمخرجات
...
-- مراجعة معتمدة
('11111111-1111-1111-1111-111111111111', '1', '33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 
...
('22222222-2222-2222-2222-222222222222', '2', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111',
...
-- تعليقات للمراجعة الأولى
((SELECT id FROM public.deliverable_reviews_2025_12_15_23_00 WHERE title LIKE '%تصميم واجهة المستخدم%'), 
 '33333333-3333-3333-3333-333333333333', 'approval_note', 
 'التصميم يتبع أفضل الممارسات في تجربة المستخدم. الألوان متناسقة والتخطيط واضح.', false),

-- تعليقات للمراجعة الثانية
((SELECT id FROM public.deliverable_reviews_2025_12_15_23_00 WHERE title LIKE '%مخطط قاعدة البيانات%'), 
 '44444444-4444-4444-4444-444444444444', 'change_request', 
 'يرجى إضافة فهرس على حقل created_at في جدول المشاريع لتحسين الأداء.', false),

((SELECT id FROM public.deliverable_reviews_2025_12_15_23_00 WHERE title LIKE '%مخطط قاعدة البيانات%'), 
 '44444444-4444-4444-4444-444444444444', 'change_request', 
 'العلاقة بين جدول العملاء والمشاريع تحتاج إلى مراجعة - يفضل إضافة cascade delete.', false),

-- رد من المطور
((SELECT id FROM public.deliverable_reviews_2025_12_15_23_00 WHERE title LIKE '%مخطط قاعدة البيانات%'), 
 '11111111-1111-1111-1111-111111111111', 'response', 
 'شكراً للملاحظات. سأقوم بإضافة الفهارس المطلوبة وتحديث العلاقات في الإصدار القادم.', false);
